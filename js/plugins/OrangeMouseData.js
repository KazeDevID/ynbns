...
(function($) {
  ...
  $._onMouseUp = function(event) {
    ...
    if (switchId > 0) {
      ...
      OrangeMouseData.mouseClick = false
    }
  };
  ...
  $._onMouseDown = function(event) {
    ...
    if (switchId > 0) {
      ...
      OrangeMouseData.mouseClick = true
      
    }
    console.log(OrangeMouseData.mouseX,OrangeMouseData.mouseY)
  };
