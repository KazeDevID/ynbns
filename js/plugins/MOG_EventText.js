...
Game_Event.prototype.check_event_text = function() {
	...
	if (!this._erased && this.page()) {this.list().forEach(function(l) {
	       if (l.code === 108) {var comment = l.parameters[0].split(' : ')
			   ...
			   if (comment[0].toLowerCase() == "character_stats"){
				console.log("Current Character "+String(comment[1]));			  
			 };
...
Sprite_CharText.prototype.create_char_text = function() {
     ...
     this._char_text = new Sprite(new Bitmap(140,52));
...
Sprite_CharText.prototype.refresh_char_text = function() {
	...
	if(text=="MageInfo"){
		this._char_text.bitmap.drawText("Referral Required",0,0,135,32,"center");
		this._char_text.bitmap.drawText("2/2",0,18,135,32,"center");
		return;
	}
